...
This is the official implementation of [CURATE (accepted to TMLR 2026)](https://montrealrobotics.ca/curate/), an automatic curriculum learning algorithm for reinforcement learning agents.
